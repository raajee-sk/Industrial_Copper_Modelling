...
with tab1:
    ...
    if submit_button and flag == 0:  
        ...
        with open(r'C:\Users\SKAN\Desktop\Raajee\copper\scaler.pkl', 'rb') as f:
          scaler_loaded = pickle.load(f)
        with open(r'C:\Users\SKAN\Desktop\Raajee\copper\t.pkl', 'rb') as f:
          t_loaded = pickle.load(f)
        with open(r'C:\Users\SKAN\Desktop\Raajee\copper\s.pkl', 'rb') as f:
        ...
        new_sample1 = np.concatenate((new_sample[:,[0,1,2,3,4,5,6]],new_sample_ohe, new_sample_be), axis=1)
        new_sample2 = scaler_loaded.transform(new_sample1)
        new_pred = loaded_model.predict(new_sample2)[0]
...
with tab2:
    ...
    if csubmit_button or cflag == 0:
        import pickle
        with open(r'C:\Users\SKAN\Desktop\Raajee\copper\cmodel.pkl', 'rb') as file:
            cloaded_model = pickle.load(file)

        with open(r'C:\Users\SKAN\Desktop\Raajee\copper\cscaler.pkl', 'rb') as f:
            cscaler_loaded = pickle.load(f)

        with open(r'C:\Users\SKAN\Desktop\Raajee\copper\ct.pkl', 'rb') as f:
